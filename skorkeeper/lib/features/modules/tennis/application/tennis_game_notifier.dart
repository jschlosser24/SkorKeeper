...
import '../domain/tennis_module.dart';

part 'tennis_game_notifier.g.dart';

@riverpod
class TennisGameNotifier extends _$TennisGameNotifier {
  final TennisModule _module = const TennisModule();
